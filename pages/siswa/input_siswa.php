        ...
        <form method="post" enctype="multipart/form-data">
          <div class="card-body">
            ...
            <div class="form-group">
              <label> NIS</label>
              <input type="text" name="nis" class="form-control" placeholder="0000">
            </div>
            <!-- input nama siswa -->
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="alamat" rows="3"
                placeholder="Jalan, No.(nomor rumah), Kecamatan, Kabupaten, Provinsi"></textarea>
            </div>
            <!-- input jenis kelamin  -->
            <div class="form-group">
